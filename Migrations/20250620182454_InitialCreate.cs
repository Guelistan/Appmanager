    ...
    public partial class InitialCreate : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AppLaunchHistory", x => x.Id);
                    table.ForeignKey(
                        name: "FK_AppLaunchHistory_Applications_ApplicationId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_User_Applications_ApplicationId",
                        column: x => x.ApplicationId,
                        principalTable: "Applications",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_User_Applications_ApplicationId1",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AppLaunchHistory_ApplicationId",
                table: "AppLaunchHistory",
